                        ...
                        <div class="row">
                            <div class="col-md-6 p-5">
                                <div class="mx-auto mb-5">
                                    <a href="/">
                                        <img src="http://rahateclasses.in/wp-content/uploads/2017/05/logo-1.png" alt="" height="24" />
                                        <h3 class="d-inline align-middle ml-1 text-logo">Rahate Classes</h3>
                                    </a>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="email"
                                                ...
                                                email" placeholder="email@gmail.com" name="email" value="{{ old('email')}}" />
                            ...
                            <div class="col-lg-6 d-none d-md-inline-block">
                                <div class="auth-page-sidebar">
                                    <div class="overlay" style="background-color:#5369f8;color:#fff;"></div>
                                    <div class="auth-user-testimonial">
                                        <p class="font-size-24 font-weight-bold text-white mb-1">Date:</p>
