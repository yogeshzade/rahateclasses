...
<form class="" novalidate method="post" action="{{route('career.new.store')}}" enctype='multipart/form-data'>
                    @csrf
                <!--     @method('POST') -->
                    <div class="form-group mb-3">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <textarea id='job_description' name='job_description' id="job_description" ></textarea>               
                  ...
                  <!--   <div class="form-group mb-3">
                    ...
                    <button class="btn btn-primary" type="submit" id="submit">Create Vacancy</button>
                </form>
