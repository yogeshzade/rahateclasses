...
<form class="" novalidate method="post" action="{{route('calender.store')}}" enctype='multipart/form-data'>
                    @csrf
                <!--     @method('POST') -->
                    <div class="form-group mb-3">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <textarea id='long_desc' name='details' id="feesstruct" ></textarea>               
                     ...
                     <div class="form-group mb-3">
                        ...
                        <input type="date" class="form-control" id="validationCustom01" placeholder="Select Date"
                  ...
                  <!--   <div class="form-group mb-3">
                    ...
                    <button class="btn btn-primary" type="submit" id="submit">Create Notification</button>
                </form>
